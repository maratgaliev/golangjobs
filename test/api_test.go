...
func TestApi_CreateJob(t *testing.T) {
	...
	// 200
	catJSON = `{"is_approved": true, "website": "http://google.com", "title": "golang title", "employment_type": "remote", "currency_type": "eur", "description": "golang descr", "city": "kazan", "email": "hr@example.com", "company": "Company", "phone": "4167702450", "salary": 1000000}`
	id := 2
	req = httptest.NewRequest(echo.POST, "/api/jobs/", strings.NewReader(catJSON))
	req.Header.Set(echo.HeaderContentType, echo.MIMEApplicationJSON)
